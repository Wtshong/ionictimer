...
.controller('mainCtrl', function($scope, $ionicModal, $timeout, $ionicPlatform) {
        ...
        var QiGg_Lessions = [   {lesson: "1", step:  0, descr: "起势", duration: 10},
                                ...
                                {lesson: "2", step:  1, descr: "马步站桩", duration: 300},
                                {lesson: "2", step:  2, descr: "动作3",   duration: 10},
                                {lesson: "2", step:  3, descr: "动作4",   duration: 30},
                                {lesson: "2", step:  4, descr: "动作5",   duration: 60},
                                {lesson: "2", step:  5, descr: "动作6",   duration: 30},
                                {lesson: "2", step:  6, descr: "动作7",   duration: 60},
                                {lesson: "2", step:  7, descr: "动作8",   duration: 30},
                                {lesson: "2", step:  8, descr: "动作9",   duration: 60},
                                {lesson: "2", step:  9, descr: "动作10",  duration: 30},
                                {lesson: "2", step: 10, descr: "动作11",  duration: 10},
                                {lesson: "2", step: 11, descr: "动作12",  duration: 60, gotoStep:3, repeat:1, complete:0},
                                {lesson: "2", step: 12, descr: "End",  duration: 0}                                
            ...
            if ($scope.timer === 0) {
                ...
                if (($scope.TotalSteps > $scope.step + 1) || $scope.lesson>0) {
                    ...
                    if ($scope.step < curr_lesson.length) {
                        ...
                        $scope.startTimer(); 
                        if (curr_lesson[$scope.step].gotoStep > 0 && curr_lesson[$scope.step].complete === 0 &&  curr_lesson[$scope.step].repeat > 0) {
        ...
        $scope.getDescr = function() {
            if ($scope.step < curr_lesson.length) {
                return curr_lesson[$scope.step].descr;    
            } else {
                return "";
            }
